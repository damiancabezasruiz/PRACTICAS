...
/* ── ROW COLORS ── */
.row-iniciada td{background:rgba(209,40,40,.08)}
.row-en-curso td{background:rgba(135,198,255,.15)}
.row-cerrada td{background:rgba(97,255,154,.12)}
.row-enviada td{background:rgba(255,236,77,.12)}
.row-sin-asignar td{background:#fff}
tr.row-iniciada:hover td{background:rgba(209,40,40,.14)}
tr.row-en-curso:hover td{background:rgba(135,198,255,.22)}
tr.row-cerrada:hover td{background:rgba(97,255,154,.18)}
tr.row-enviada:hover td{background:rgba(255,236,77,.18)}
