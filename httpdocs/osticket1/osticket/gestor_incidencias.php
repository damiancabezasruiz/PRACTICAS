...
/**
 * =============================================================================
 * gestor_incidencias.php — Panel de navegación del Gestor: sección Incidencias
 * =============================================================================
 *
 * Propósito:
 ...
 *   de incidencias (form_id = 18 en osTicket).
 *
 * Acceso:
 ...
 *   - fields.php?tipo=incidencias  → Gestión de campos base del formulario
 *     (textos, textos largos, adjuntos): nombre, hint, visibilidad.
 *   - options.php?tipo=incidencias → Gestión de listas desplegables
 *     (sectores, grupos, tipos de incidencia, etc.): opciones, visibilidad.
 *
 * Aviso al usuario:
 *   Muestra un banner de advertencia indicando que los cambios afectan
 *   directamente al cuestionario de incidencias del portal de alumnos.
 *
 * Dependencias:
...
<div class="contenedor">
 ...
 <div class="contenido">
   <div class="hero">
     <h2>Cuestionario Incidencias</h2>
   </div>

   <!-- AVISO DE CAMBIOS AÑADIDO -->
   <div class="aviso-cambios">
     <i>⚠️</i>
     <p>Atención: Todos los cambios realizados en esta sección se reflejarán automáticamente en el cuestionario de incidencias del portal.</p>
   </div>

   <div class="accesos">
     <a href="fields.php?tipo=incidencias" class="card">
       <h3>🛠 Campos base</h3>
       <p>Edita nombres, visibilidad y textos de ayuda de los campos dinámicos.</p>
       <div class="flecha">Configurar campos ➔</div>
     </a>

     <a href="options.php?tipo=incidencias" class="card">
       <h3>▾ Listas desplegables</h3>
       <p>Administra los elementos de los menús de selección (sectores, grupos, etc.).</p>
