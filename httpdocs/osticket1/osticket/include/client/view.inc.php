...
<div class="pull-right">
 <a class="action-button btn-download" href="tickets.php?a=print&id=<?php
 echo $ticket->getId(); ?>">
 <i class="icon-print"></i> Descargar PDF
 </a>

<?php if ($ticket->hasClientEditableFields()
 && $thisclient->getId() == $ticket->getUserId()) { ?>

 <a class="action-button btn-edit" href="tickets.php?a=edit&id=<?php
 echo $ticket->getId(); ?>">
...
<!-- AVISO ACCESO TEMPORAL -->
<div class="warning-box-full">
    ⚠️ <strong>IMPORTANTE:</strong> El acceso a este ticket puede caducar en 24 horas por motivos de seguridad.
    Se recomienda descargar el PDF para conservar una copia oficial de la incidencia.
</div>
