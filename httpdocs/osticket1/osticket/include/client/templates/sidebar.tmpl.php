...
<?php } ?>
    ...
    if ($cfg->isKnowledgebaseEnabled()
        ...
        && $faqs->all()) { ?>
            <section><div class="header"><?php echo __('Featured Questions'); 
?></div>
...
<?php
    ...
    if ($resources->all()) { ?>
            <section><div class="header"><?php echo __('Other Resources'); 
?></div>
<?php   foreach ($resources as $page) { ?>
            <div><a href="<?php echo ROOT_PATH; ?>pages/<?php echo 
$page->getNameAsSlug();
