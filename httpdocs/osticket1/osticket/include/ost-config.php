...
define('SECRET_SALT','vrODCx60c9qk85z00qmPhGT7PCgprCjh');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','admin@incidencias.grupoatu.com');
...
define('DBNAME','bd_ostickets_atu');
define('DBUSER','user_bd_atu');
define('DBPASS','q5DzXzsN!wf0*qj1');
