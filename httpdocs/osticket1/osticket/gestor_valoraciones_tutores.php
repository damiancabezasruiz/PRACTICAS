...
/**
 * =============================================================================
 * gestor_valoraciones_tutores.php — Panel de navegación del Gestor: sección Valoración de Tutores
 * =============================================================================
 *
 * Propósito:
 ...
 *   de valoración de tutores (form_id = 22 en osTicket).
 *
 * Acceso:
 ...
 *   - fields.php?tipo=valoraciones_tutores  → Gestión de campos base del formulario
 *     de valoración de tutores: nombre visible, texto de ayuda (hint), visibilidad.
 *   - options.php?tipo=valoraciones_tutores → Gestión de listas desplegables
 *     del cuestionario de valoración de tutores: opciones, visibilidad por sección.
 *
 * Aviso al usuario:
 *   Muestra un banner de advertencia indicando que los cambios afectan
 *   directamente al cuestionario de valoración de tutores del portal.
 *
 * Dependencias:
...
<title>Gestión - Valoración de Tutores</title>
...
<div class="contenedor">
  ...
  <div class="contenido">
    <div class="hero">
      <h2>Cuestionario Valoración de Tutores</h2>
    </div>

    <!-- AVISO DE CAMBIOS -->
    <div class="aviso-cambios">
      <i>⚠️</i>
      <p>Atención: Todos los cambios realizados en esta sección se reflejarán automáticamente en el cuestionario de valoración de tutores del portal.</p>
    </div>

    <div class="accesos-principales">
      <a href="fields.php?tipo=valoraciones_tutores" class="acceso-card">
        <h3>🎓 Campos base</h3>
        <p>Gestiona nombres, textos de ayuda, visibilidad y orden de los campos del formulario de valoración de tutores.</p>
        <div class="flecha">Configurar campos ➔</div>
      </a>

      <a href="options.php?tipo=valoraciones_tutores" class="acceso-card lista">
        <h3>▾ Listas desplegables</h3>
        <p>Administra las opciones internas de cada selector y menús de selección múltiple del cuestionario de tutores.</p>
